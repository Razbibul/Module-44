...
class LoginPage(BasePage):
    ...
    def should_be_login_form(self):
        ...
        assert self.is_element_present(*LoginPageLocators.LOGIN_FORMA), "НЕТ ФОРМЫ АВТОРИЗАЦИИ"
        #assert True

    def should_be_register_form(self):
        # реализуйте проверку, что есть форма регистрации на странице
        assert self.is_element_present(*LoginPageLocators.ATHORIZED_FORMA), "НЕТ ФОРМЫ РЕГИСТРАЦИИ"
        #assert True
